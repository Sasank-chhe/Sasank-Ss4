...
#### login ####
 login()
	...
	:
		...
		print
		id=Sasank-chhe(S + '[☆] ' + S + 'Email: ' + G +'')
		pwd=Sasank2006#(S + '[♡] ' + R + 'Password : ')
...
def pb():
	...
	if bp =='':
		...
		cb()
		print (logo)
		idt=Sasank-chhe(S + '[☆] ' + G + 'Put Public User ID/User Name: ' + W + '')
		cb()
		print (logo)
		try:
